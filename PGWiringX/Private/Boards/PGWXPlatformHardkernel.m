...
@implementation PGWXPlatformHardkernelOdroidC1 {
    ...
    -(instancetype)init:(NSError **)error {
        return (self = [super init:error]);
    }

    -(NSString *)boardName {
        return PGWX_OdroidC1;
    }
    ...
    -(PGWXSOC *)soc {
        ...
        @try {
            if(_soc == nil) {
                _soc = [[PGWXSOCAmlogicS805 alloc] init:nil];
            }
        }
        @finally {
            [self unlock];
...
@implementation PGWXPlatformHardkernelOdroidC2 {
    ...
    -(PGWXSOC *)soc {
        ...
        @try {
            if(_soc == nil) {
                _soc = [[PGWXSOCAmlogicS905 alloc] init:nil];
            }
        }
        @finally {
            [self unlock];
...
@implementation PGWXPlatformHardkernelOdroidXU4 {
    ...
    -(PGWXSOC *)soc {
        ...
        @try {
            if(_soc == nil) {
                _soc = [[PGWXSOCSamsungExynos5422 alloc] init:nil];
            }
        }
        @finally {
            [self unlock];
